...
Object::Object(Game& g,obj_t t,int l,SDL_Texture* sprt):game(g),type(t),life(l),sheet(sprt)
{
    renderer = game.pwindow.renderer;

}


Object::Object(Game &g,obj_t t,float x,float y,float vx,float vy,SDL_Texture* ss)
...
Object::Object(Game& g,obj_t t,int l,int w,int h,SDL_Texture* ss):game(g),type(t),life(l),_w(w),_h(h),sheet(ss)
{
    renderer = game.pwindow.renderer;
    _x = 200;
    _y = 200;
...
void Object::draw()
{
    cout<<type<<"going to be rendered"<<endl;
    renderer->renderSprite(curSprite,_x,_y);
